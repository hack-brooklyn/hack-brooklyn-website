...
import '../styles/scss/SocialGood.module.scss';
      ...
      <div className="card-group">
        <div className={(width < 450 ? "col-9" : "col-md-6 col-lg-3") + " card-container"}>
          <div className="card text-center">
            <img src={"assets/social-good/sustainability.svg"} className="card-img-top" alt="..." />
        ...
        <div className={(width < 450 ? "col-9" : "col-md-6 col-lg-3") + " card-container"}>
          <div className="card text-center">
            <img src={"assets/social-good/accessibility.svg"} className="card-img-top" alt="..." />
            <div className="card-body">
        ...
        <div className={(width < 450 ? "col-9" : "col-md-6 col-lg-3") + " card-container"}>
          <div className="card text-center">
            <img src={"assets/social-good/education.svg"} className="card-img-top" alt="..." />
            <div className="card-body">
        ...
        <div className={(width < 450 ? "col-9" : "col-md-6 col-lg-3") + " card-container"}>
          <div className="card text-center">
            <img src={"assets/social-good/health.svg"} className="card-img-top" alt="..." />
            <div className="card-body">
